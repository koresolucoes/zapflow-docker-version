...
const Sidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { icon: <ACTIVITY_ICON className="w-5 h-5" />, label: 'Atividades', page: 'activities' as Page },
    { icon: <TASKS_ICON className="w-5 h-5" />, label: 'Tarefas', page: 'tasks' as Page },
  ...
  const bottomNavItems = [
    ...
    { icon: <PROFILE_ICON className="w-5 h-5" />, label: 'Perfil da Empresa', page: 'company-profile' as Page },
